...
import json
result = {}
url_page = "https://webapi.sporttery.cn/gateway/lottery/getHistoryPageListV1.qry?gameNo=85&provinceId=0&isVerify=1&pageNo=1&pageSize=100"
response_page = requests.get(url_page)
json_data_page = response_page.json()
data_page = json_data_page['value']
pages = data_page['pages']
url = "https://webapi.sporttery.cn/gateway/lottery/getHistoryPageListV1.qry?gameNo=85&provinceId=0&isVerify=1&pageNo={}&pageSize=100"
